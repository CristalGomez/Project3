...
// *********************************************************************************************************************************************************
//   Loginscreen.js is the page which acts as a container to switch between login and registration components defined in Login.js and SignUp.js respectively.
// *********************************************************************************************************************************************************
...
class Loginscreen extends Component {
  ...
  handleClick(event,userRole){
    ...
    if(this.state.isLogin){
      let loginscreen=[];
      loginscreen.push(<SignUp parentContext={this} appContext={this.props.appContext} role={userRole}/>);
